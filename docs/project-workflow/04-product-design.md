...
> **版本**: v3.1 | **更新日期**: 2026-06-02 | **状态**: 三Tab导航，AI整合首页，统计整合我的
...
首页为核心入口，整合记账输入和AI对话功能。页面可上下滚动，上半部分为记账区，下半部分为AI对话区。
...
| 组件 | 功能 | 状态管理 | 数据源 |
|------|------|----------|--------|
| TransactionInputWidget | 记账输入 | Riverpod | 本地 |
...
| AiChatSection | AI对话区 | Riverpod | AI服务+本地 |
...
### 4.2.3 我的页面 - 个人信息 + 统计概览

我的页面整合统计功能，顶部显示统计概览，下方为个人设置入口。
